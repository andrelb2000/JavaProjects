...
public class Concessionaria {
    ...
    public void executar(){
        ...
        viewCarros = new CarrosJFrame();
        viewCarros.adicionarListernerInserir(new InserirListener());
        viewCarros.adicionarListernerListar(new ListarListener());
        
        viewCarros.setVisible(true);
    }
    ...
    public class InserirListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Carro cInserir = viewCarros.obterCarroInserido();
            banco.inserirBanco(cInserir);
        }        
    }
    public class ListarListener implements ActionListener{
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            viewCarros.preencherLista(banco.lerBanco());
        }        
    }
}
